const Page = ({}) => {
    return (
        <div id="Main" className="flex justify-center p-8">
            <div id="Recent News" className="rounded-xl bg-[#3c3374] drop-shadow-xl h-auto w-[25%] inline-grid transition-all ease-in-out duration-150 p-2 hover:border-1 hover:scale-[115%] ">
