...
{
    return (
        <button onClick={() => {window.open(catURL,'_blank')}} className="hover:bg-white content-box transition-all h-fit w-fit ease-in-out duration-200 rounded-lg hover:text-gray-800" >
